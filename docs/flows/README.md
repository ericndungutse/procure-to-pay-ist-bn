# Procure-to-Pay System Flows

This folder contains **business process flow diagrams** for the Procure-to-Pay system. Each diagram is represented as a Mermaid sequence diagram and documents the interaction between users, the API, the database, and other services.
